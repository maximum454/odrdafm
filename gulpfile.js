...
gulp.task('html:build', function () {
    gulp.src(orda.src.html)
        .pipe(plugins.rigger())
        .pipe(gulp.dest(orda.build.html))
...
gulp.task('watch', function(){
    plugins.watch([orda.watch.html], function(event, cb) {
        gulp.start('html:build');
    });
    plugins.watch([orda.watch.style], function(event, cb) {
        gulp.start('style:build');
    });
    plugins.watch([orda.watch.js], function(event, cb) {
        gulp.start('js:build');
    });
    plugins.watch([orda.watch.img], function(event, cb) {
        gulp.start('image:build');
    });
    plugins.watch([orda.watch.fonts], function(event, cb) {
